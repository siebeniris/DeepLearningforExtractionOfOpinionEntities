...
filepath='experiments/cnn_embed/notrainable/crf/03'
...
# compile model
model.compile(optimizer = 'adadelta', loss='categorical_crossentropy', metrics=[crf.accuracy], sample_weight_mode='temporal')
print(model.summary())
